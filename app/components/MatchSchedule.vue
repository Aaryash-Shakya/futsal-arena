<template>
	<div class="rounded-lg shadow-md border overflow-hidden backdrop-blur-sm" style="background-color: var(--color-bg-surface); border-color: var(--color-bg-muted);">
		<div class="px-4 py-4 border-b" style="background-color: var(--color-bg-surface); border-color: var(--color-bg-muted);">
		...
		<div v-if="isLoading" class="p-4">
			<div class="flex flex-col gap-2">
				<div
					v-for="n in 3"
					:key="n"
					class="flex items-center px-4 py-2 rounded-lg animate-pulse mb-1"
				...
				>
					...
					<!-- Date Skeleton -->
					<div class="ml-6 w-24">
						<div class="h-4 rounded w-full" style="background-color: var(--color-bg-muted);" />
					</div>
				</div>
			</div>
		</div>
		...
		<div v-else class="p-4">
			<div class="flex flex-col gap-2">
				<div
					...
					:key="match._id"
					class="flex items-center px-4 py-2 rounded-lg transition-all duration-200 hover:shadow-md border mb-1"
				...
				>
					...
					<div class="px-4 flex items-center justify-center">
						...
						<span v-else class="text-sm font-medium" style="color: var(--color-text-muted);">vs</span>
					</div>
